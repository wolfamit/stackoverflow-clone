                ...
                <div className="post-header">
                    <div>
                        <Link to={`/Users/${postdetails.userId}`}>
                            <Avatar py='30px' px='30px' borderRadius='50%' imageSrc={  postdetails.picturePath.length <= 10 ? `${process.env.REACT_APP_BASE_URL}/assets/${postdetails?.userPicturePath}` : postdetails?.userPicturePath} />
                        </Link>
                    </div>
